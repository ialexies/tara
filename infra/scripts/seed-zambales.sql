...
BEGIN
  INSERT INTO properties (
    ...
    '4e737f48-27ca-4fef-adf0-b613b8af7ad0', '4e737f48-27ca-4fef-adf0-b613b8af7ad0',
  ...
  VALUES (
    pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Pine Grove Dorm A (Mixed)', 'anawangin-pine-grove-dorm-a',
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    ...
    is_mock, cover_image_url, description, min_nights)
  VALUES (
    pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Pine Grove Dorm B (Female)', 'anawangin-pine-grove-dorm-b',
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    ...
    is_mock, cover_image_url, description, min_nights)
  VALUES (
    pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Cove View Private', 'anawangin-cove-view-private',
  ...
  SELECT r1, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Bed ' || gs, true FROM generate_series(1,10) gs;

  INSERT INTO units (room_id, tenant_id, label, is_mock)
  SELECT r2, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Bed ' || gs, true FROM generate_series(1,8) gs;

  INSERT INTO units (room_id, tenant_id, label, is_mock)
  SELECT r3, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Room ' || gs, true FROM generate_series(1,2) gs;

  INSERT INTO property_images (property_id, tenant_id, url, position)
  VALUES
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/cd3b9562-45f7-41a6-8bb6-be76ce2ae5d1.jpg', 1),
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/a0f5a067-25e1-40c6-aa66-9468b657052a.jpg', 2),
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/07627cc2-6fbe-41d8-bf5b-2b2c8f51aee0.jpg', 3),
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/f2d4084a-e78c-4e2c-81fb-1225e70f7595.jpg', 4);
END $$;
...
BEGIN
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Surfer Dorm A', 'liwliwa-surfer-dorm-a',
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Surfer Dorm B (Female)', 'liwliwa-surfer-dorm-b',
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Beachfront Kubo', 'liwliwa-beachfront-kubo',
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Garden Twin', 'liwliwa-garden-twin',
  ...
  INSERT INTO units (room_id, tenant_id, label, is_mock)
  SELECT r1, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Bed ' || gs, true FROM generate_series(1,8) gs;

  INSERT INTO units (room_id, tenant_id, label, is_mock)
  SELECT r2, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Bed ' || gs, true FROM generate_series(1,6) gs;

  INSERT INTO units (room_id, tenant_id, label, is_mock)
  SELECT r3, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Kubo ' || gs, true FROM generate_series(1,3) gs;

  INSERT INTO units (room_id, tenant_id, label, is_mock)
  SELECT r4, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Room ' || gs, true FROM generate_series(1,4) gs;

  INSERT INTO property_images (property_id, tenant_id, url, position)
  VALUES
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/83d8671e-d606-4ba3-be9c-b631088fe25f.jpg', 1),
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/fc6861aa-2007-4556-aa72-2f248f1e9f00.jpg', 2),
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/ecd23c02-b5e1-4b0e-9e3a-84e8b41799b3.jpg', 3),
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/83a02164-1201-451d-8b58-8b1bd733aa3c.jpg', 4);
END $$;
...
BEGIN
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Diver Dorm (6-bed)', 'subic-diver-dorm',
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Standard Double', 'subic-standard-double',
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Bay View Room', 'subic-bay-view-room',
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Family Suite', 'subic-family-suite',
  ...
  INSERT INTO units (room_id, tenant_id, label, is_mock)
  SELECT r1, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Bed ' || gs, true FROM generate_series(1,6) gs;

  INSERT INTO units (room_id, tenant_id, label, is_mock)
  SELECT r2, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Room ' || gs, true FROM generate_series(1,6) gs;

  INSERT INTO units (room_id, tenant_id, label, is_mock)
  SELECT r3, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Room ' || gs, true FROM generate_series(1,4) gs;

  INSERT INTO units (room_id, tenant_id, label, is_mock)
  SELECT r4, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Suite ' || gs, true FROM generate_series(1,3) gs;

  INSERT INTO property_images (property_id, tenant_id, url, position)
  VALUES
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/57cfd4f8-f594-4d82-9965-93e84255f7be.jpg', 1),
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/cd3b9562-45f7-41a6-8bb6-be76ce2ae5d1.jpg', 2),
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/1571ad1c-d061-4a1a-8a54-c380c217c925.jpg', 3),
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/9fe64752-02f0-44b9-91cd-7a82a675b63f.jpg', 4);
END $$;
...
BEGIN
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Bamboo Bunkhouse A', 'nagsasa-bamboo-bunkhouse-a',
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Bamboo Bunkhouse B', 'nagsasa-bamboo-bunkhouse-b',
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Glamping Tent', 'nagsasa-glamping-tent',
  ...
  INSERT INTO units (room_id, tenant_id, label, is_mock)
  SELECT r3, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Tent ' || gs, true FROM generate_series(1,4) gs;

  INSERT INTO property_images (property_id, tenant_id, url, position)
  VALUES
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/f45c91bc-e602-4974-bf57-46939f87f78c.jpg', 1),
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/a4bc93f1-42fa-428d-bbf2-3956d11debd9.jpg', 2),
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/6520c418-8c41-4984-8fd6-da76e3cab9a4.jpg', 3);
END $$;
...
BEGIN
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'A/C Mixed Dorm (8-Bed)', 'olongapo-ac-mixed-8',
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Female Dorm (6-Bed)', 'olongapo-female-6',
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Budget Dorm (4-Bed)', 'olongapo-budget-4',
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Private Double', 'olongapo-private-double',
    'private', 'private', 2, true, true, false, true, 200000, true,
    'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/922a399b-b515-441c-a8c8-c9129af12f28.jpg',
  ...
  INSERT INTO units (room_id, tenant_id, label, is_mock)
  SELECT r3, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Bed ' || gs, true FROM generate_series(1,4) gs;

  INSERT INTO units (room_id, tenant_id, label, is_mock)
  SELECT r4, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Room ' || gs, true FROM generate_series(1,6) gs;

  INSERT INTO property_images (property_id, tenant_id, url, position)
  VALUES
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/07627cc2-6fbe-41d8-bf5b-2b2c8f51aee0.jpg', 1),
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/a3a2dc8d-79f3-411d-8636-d3c49f0a76cf.jpg', 2),
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/ed038bbb-8d02-4f77-831c-7b5454b545c1.jpg', 3),
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/718659b9-f748-4d98-886b-9e06b5b1bda5.jpg', 4);
END $$;
...
BEGIN
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Deluxe Beachfront Room', 'pundaquit-deluxe-beachfront',
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Family Cottage', 'pundaquit-family-cottage',
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Standard Room', 'pundaquit-standard-room',
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Pool Suite', 'pundaquit-pool-suite',
  ...
  INSERT INTO units (room_id, tenant_id, label, is_mock)
  SELECT r1, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Room ' || gs, true FROM generate_series(1,6) gs;

  INSERT INTO units (room_id, tenant_id, label, is_mock)
  SELECT r2, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Cottage ' || gs, true FROM generate_series(1,4) gs;

  INSERT INTO units (room_id, tenant_id, label, is_mock)
  SELECT r3, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Room ' || gs, true FROM generate_series(1,10) gs;
  ...
  INSERT INTO property_images (property_id, tenant_id, url, position)
  VALUES
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/9fe64752-02f0-44b9-91cd-7a82a675b63f.jpg', 1),
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/1571ad1c-d061-4a1a-8a54-c380c217c925.jpg', 2),
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/a6c08aa6-7364-46cf-b683-83c76ed502d9.jpg', 3),
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/cd3b9562-45f7-41a6-8bb6-be76ce2ae5d1.jpg', 4),
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/57cfd4f8-f594-4d82-9965-93e84255f7be.jpg', 5);
END $$;
...
BEGIN
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Studio Unit', 'sa-studio-unit',
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', '1-Bedroom Apartment', 'sa-1br-apartment',
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', '2-Bedroom Apartment', 'sa-2br-apartment',
  ...
  INSERT INTO units (room_id, tenant_id, label, is_mock)
  SELECT r1, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Unit ' || gs, true FROM generate_series(1,6) gs;

  INSERT INTO units (room_id, tenant_id, label, is_mock)
  SELECT r2, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Unit ' || gs, true FROM generate_series(1,5) gs;

  INSERT INTO units (room_id, tenant_id, label, is_mock)
  SELECT r3, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Unit ' || gs, true FROM generate_series(1,3) gs;

  INSERT INTO property_images (property_id, tenant_id, url, position)
  VALUES
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/ed038bbb-8d02-4f77-831c-7b5454b545c1.jpg', 1),
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/718659b9-f748-4d98-886b-9e06b5b1bda5.jpg', 2),
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/a6c08aa6-7364-46cf-b683-83c76ed502d9.jpg', 3);
END $$;
...
BEGIN
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Budget Dorm (10-Bed)', 'zbi-budget-dorm-10',
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Budget Dorm (6-Bed)', 'zbi-budget-dorm-6',
  ...
  INSERT INTO rooms (property_id, tenant_id, name, slug, room_type, bathroom_type, capacity,
    has_aircon, has_window, has_locker, has_outlet_per_bed, base_nightly_rate_minor,
    is_mock, cover_image_url, description, min_nights)
  VALUES (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'Basic Private Room', 'zbi-basic-private',
    'private', 'shared', 2, false, true, false, true, 120000, true,
    'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/6520c418-8c41-4984-8fd6-da76e3cab9a4.jpg',
  ...
  INSERT INTO property_images (property_id, tenant_id, url, position)
  VALUES
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/6520c418-8c41-4984-8fd6-da76e3cab9a4.jpg', 1),
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/83a02164-1201-451d-8b58-8b1bd733aa3c.jpg', 2),
    (pid, '4e737f48-27ca-4fef-adf0-b613b8af7ad0', 'https://pub-9b3c6c52ef10449a887ad24b73985c83.r2.dev/seed/a4bc93f1-42fa-428d-bbf2-3956d11debd9.jpg', 3);
END $$;
